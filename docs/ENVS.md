...
| NEXT_PUBLIC_SEARCH_SHARDS | `string` | Used for set shards instances that will used for multishard search | - | - | `[{'title':'Anyblock','baseUrl':'https://explorer.anyblock.tools','paths':{'tx':'/ethereum/poa/core/tx'}}]` |

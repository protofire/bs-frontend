...
| NEXT_PUBLIC_NETWORK_RPC_URL                | `string`  | See in [Blockchain parameters](ENVS.md#blockchain-parameters) section                                                                                                                                                                                                                                     | Required       | -             | `https://core.poa.network`                                      |
| NEXT_PUBLIC_STAKING_OVERVIEW_URL           | `string`  |                                                                                                                                                                                                                                                                                                           | Required       | -             | `https://example.com?{address}`                                 |
...
Used to fetch staked balances to a given address. Used in the address details page.
| Variable | Type| Description | Compulsoriness | Default value | Example value |
| --- | --- | --- | --- | --- | --- |
| NEXT_PUBLIC_STAKING_API_HOST | `string` | API URL | Required | `https://api.stake.hmny.io`|`https://api.stake.hmny.io`|
| NEXT_PUBLIC_STAKING_API_NETWORK |`string`| Site key | Required |`testnet`|`testnet` |
